...
export class InMemoryCartActorService implements KeyedActorService {
...
export const createInMemoryCartActorService = (): KeyedActorService =>
  new InMemoryCartActorService();
