...
const forbiddenImport = (specifier: string): boolean =>
  ...
  specifier.startsWith("@ecommerce/product/") ||
  specifier.startsWith("@ecommerce/pricing/") ||
  specifier.startsWith("@ecommerce/inventory/") ||
  specifier.startsWith("@ecommerce/payment/");
...
describe("cart module boundaries", () => {
  it("does not import runtime-specific modules or dependency internals", () => {
