...
export class InMemoryInventoryCoordinator implements StatefulCoordinator {
...
export const createInMemoryInventoryCoordinator = (): StatefulCoordinator =>
  new InMemoryInventoryCoordinator();
